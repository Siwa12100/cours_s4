package models;// package tetepremiere.commande.groupe;
...
public class Telecommande {
	...
	public Commande[] getCommandesMarche() {
		return this.commandesMarche;
	}

	public Commande[] getCommandesArret() {
		return this.commandesArret;
	}

	public Commande getCommandeAnnulation() {

		return this.commandeAnnulation;
	}
}
